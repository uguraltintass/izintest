...
import com.izinmodul.entities.*;
import com.izinmodul.forms.LeaveHistory;
import com.izinmodul.repositories.*;
...
public class LeaveHistoryService {
    ...
    @Transactional(readOnly = true)
    public List<LeaveHistory> getLeaveByManager(String id) {

        log.info("Received request to return list of all Leave by Manager ");

        try {
            List<LeaveHistory> leaveHistoryList = new ArrayList<LeaveHistory>();
            EmployeeEntity employeeEntity1 = employeeRepository.findById(id);
            ...
            log.error("Leave listing for manager " + id + " failed, Exception thrown ", e);
        }
    ...
    @Transactional(readOnly = true)
    public List<LeaveHistory> getPassedLeaveByEmployee(String id) {

        log.info("Received request to return list of utilized leave for user: " + id);
        ...
        try {
            ...
            log.info("A total of " + leaveHistoryList.size() + " leave applications were utilized by user: " + id);

            return leaveHistoryList;
        } catch (Exception e) {
            log.error("Leave listing for user: " + id + " failed, Exception thrown ", e);
        }
    ...
    @Transactional(readOnly = true)
    public List<LeaveHistory> getActiveLeaveByEmployee(String id) {
        ...
        try {
            ...
            log.info("A total of " + leaveHistoryList.size() + " leave applications were applied by user: " + id);
    ...
    @Transactional(readOnly = true)
    public List<LeaveHistory> getCancelledLeaveByEmployee(String id) {

        log.info("Received request to return list of cancelled leave for user: " + id);
        ...
        try {
            ...
            log.info("A total of " + leaveHistoryList.size() + " leave applications were cancelled by user: " + id);

            return leaveHistoryList;
        } catch (Exception e) {
            log.error("Cancelled Leave listing for user: " + id + " failed, Exception thrown ", e);
        }
    ...
    @Transactional(readOnly = true)
    public List<LeaveHistory> getFutureLeaveByEmployee(String id) {
    ...
    @Transactional
    public LeaveResponse addLeave(LeaveHistoryEntity leaveHistoryEntity, String id) {
        ...
        try {
            ...
            log.error("Leave creation failed for " + id + ", Exception thrown ", e);
        }
    ...
    @Transactional
    public LeaveResponse cancelLeave(int leaveId, String id) {
        try {
            log.info("Cancelling leave with id: " + leaveId + " for user: " + id);
            ...
            leaveHistoryRepository.save(leaveHistoryEntity);
            log.info("LeaveId: " + leaveId + " succesfully deleted for user: " + id);
